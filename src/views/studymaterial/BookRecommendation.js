...
const BookRecommendation = ({ classes }) => {
            ...
            const fetchRecommendations = async () => {
                ...
                const prompt = {
                    prompt: `Generate a list of top 2 book recommendations on the topic of "${topic}". Include the book title, a buyable link to the book, its price, description,rating and the author's name. Format must be a JSON Array with the json object title,link,description, author, rating,price. Only Generate the link if the link is in knowledgebase`,
                  };
  ...
  return (
    <div>BookRecommendation
      ...
      {recommendations.length > 0 && (
        <div>
                <h5 style={{textAlign:'center'}}>Top 10 Books of {topic}</h5>
